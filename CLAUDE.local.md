...
**YOU ARE IN: `videocall/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/videocall/` (rig root) or other directories
...
**Your mail address:** `videocall/polecats/furiosa`
**Your rig:** videocall
**Your Witness:** `videocall/witness`
...
| Ask Witness for help | `gt mail send videocall/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`videocall/witness`) when:
...
```bash
gt mail send videocall/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
